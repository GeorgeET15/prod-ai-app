  ...
  const features = [
    {
      ...
      description:
        "Real-time monitoring with predictive analytics to identify budget overruns, schedule delays, and crew issues before they escalate.",
    },
    {
      icon: TrendingUp,
      title: "What-If Simulations",
      description:
        "Test different scenarios and see projected impacts on budget, schedule, and resources before making critical decisions.",
    },
    {
      icon: AlertCircle,
      title: "Smart Alerts & Insights",
      description:
        "Get intelligent notifications about potential risks with confidence scores and actionable recommendations.",
    },
    {
      icon: Zap,
      title: "Natural Language Queries",
      description:
        "Ask questions in plain language about your production status, budget, schedule, and team performance.",
    },
    {
      icon: Shield,
      title: "Unified Command Center",
      description:
        "Manage all aspects of production from a single integrated dashboard - from pre-production to distribution.",
    },
    {
      icon: Clock,
      title: "Real-Time Tracking",
      description:
        "Monitor shoot days, dailies review, equipment status, and crew availability in real-time.",
    },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-6 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Unified platform that centralizes all aspects of film production
            with predictive AI, risk detection, and intelligent decision-making
            for Indian cinema workflows.
          </p>
      ...
      <section id="demo" className="container mx-auto px-6 py-20">
        <div className="max-w-5xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Experience how POD . AI streamlines workflows, predicts risks, and
            keeps your film projects on track.
          </p>
          <Card className="overflow-hidden rounded-2xl shadow-lg">
            <video
              controls
              className="w-full rounded-2xl"
              poster="/thumbnail.png" // replace with your thumbnail image
            >
              <source src="/ByteME.mp4" type="video/mp4" />{" "}
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="bg-gradient-primary rounded-3xl p-12 text-center text-primary-foreground">
          ...
          <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
            Join hundreds of production houses using Production Copilot to
        ...
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              © 2025 POD.AI. AI-Powered Production Management for Indian Cinema.
            </p>
          </div>
        </div>
      </footer>
